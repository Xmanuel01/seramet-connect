export const company = {
  name: "Mona Swahili",
  branches: ["All Branches", "Westlands", "Ngong Road"],
};

export const ksh = (n: number) => "KSh " + n.toLocaleString("en-KE", { maximumFractionDigits: 0 });
...
export const alerts = [
  {
    sev: "critical",
    title: "4 items are below PAR",
    detail: "Cooking oil, beef boneless, tomatoes, foil",
    branch: "Westlands",
    time: "12 min ago",
    action: "Generate PO",
  },
  {
    sev: "warning",
    title: "Cash variance of KSh 850 requires approval",
    detail: "Till 2 close-out, cashier Amina W.",
    branch: "Ngong Road",
    time: "38 min ago",
    action: "Review",
  },
  {
    sev: "warning",
    title: "Average kitchen time increased 18%",
    detail: "14.2 min vs 12.0 min baseline",
    branch: "Westlands",
    time: "1 hr ago",
    action: "Open KDS",
  },
  {
    sev: "info",
    title: "Supplier beef price increased 12%",
    detail: "Main Meat Supplier - effective today",
    branch: "All",
    time: "2 hr ago",
  ...
  },
  {
    ...
    detail: "Total value KSh 128,400",
    branch: "All",
    time: "3 hr ago",
    action: "Approve",
  },
...
export const products: Product[] = [
  ...
  },
  {
    ...
    out: true,
    productionStation: "GRILL",
    branchAvailability: { Westlands: true, "Ngong Road": false },
    importSource: "menu-import",
  },
  {
    id: "p14",
  ...
  },
  {
    ...
    price: 300,
    prep: 7,
    productionStation: "DESSERT",
    importSource: "menu-import",
  },
];

export const serametPosTerminal = {
  id: "WEST-POS-01",
  companyName: "Mona Swahili",
  branch: "Westlands" as const,
  role: "Branch Manager" as const,
  cashier: "Emmanuel Obiambo",
};

export const menuImportSummary = {
  source: "Menu import + manager edits",
  rows: products.length,
  categories: Array.from(new Set(products.map((product) => product.category))).length,
  lastImported: "13 Aug 2026, 10:18",
};
...
export const tickets = [
  {
    ...
    mins: 8,
    state: "NEW",
    items: ["Chicken Biryani x2", "Beef Dry Fry x1"],
    note: "NO CHILLI",
  },
  {
    id: "1843",
    ...
    mins: 6,
    state: "NEW",
    items: ["Fish Curry x1", "Chapati x2"],
  },
  {
    id: "1839",
    table: "03",
    ...
    mins: 19,
    state: "PREPARING",
    items: ["Beef Pilau x3", "Bhajia x2", "Passion Juice x3"],
  ...
  },
  {
    ...
    mins: 15,
    state: "PREPARING",
    items: ["Chicken Curry x2", "Chips x1"],
  },
  {
    id: "1836",
    table: "02",
    ...
    mins: 28,
    state: "READY",
    items: ["Viazi Karai x2", "Mahamri x1"],
  },
  { id: "1837", table: "TA-19", time: "12:26 PM", mins: 24, state: "READY", items: ["Kaimati x3"] },
];
...
export const decisions = [
  {
    title: "Approve Purchase Order PO-2026-0182",
    value: 58400,
    ctx: "Main Meat Supplier  -  Westlands",
    reason: "Weekly meat replenishment, 3 items below PAR",
    by: "Kelvin M. (Storekeeper)",
    time: "22 min ago",
  },
  {
    title: "Approve cash variance",
    value: 850,
    ctx: "Till 2  -  Ngong Road",
    reason: "Shortage at shift close-out",
    by: "Amina W. (Cashier)",
    time: "38 min ago",
  },
  {
    ...
    value: 4200,
    ctx: "Order #1798  -  Westlands",
    reason: "Cold food complaint, escalated by supervisor",
    by: "Joan A. (Supervisor)",
    time: "1 hr ago",
  },
  {
    title: "Approve overtime - 3 employees",
    value: 6300,
    ctx: "Kitchen  -  Westlands",
    reason: "Saturday event coverage, 12 extra hours",
    by: "Chef Musa",
    time: "2 hr ago",
  },
];
