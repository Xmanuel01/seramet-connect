...
export const Route = createFileRoute("/prep")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Daily kitchen prep list driven by forecast demand and current par stock." },
      { property: "og:title", content: "Prep List — Seramet" },
      { property: "og:description", content: "Forecast-driven prep tasks for the kitchen brigade." },
...
const sections = [
  {
    station: "Hot line",
    tasks: [
      { t: "Marinate chicken", target: "18 kg", done: "18 kg", who: "Musa K.", status: "Completed" },
      { t: "Par-cook biryani rice", target: "40 portions", done: "26 portions", who: "Peter K.", status: "Preparing" },
  ...
  },
  {
    station: "Beverages",
    tasks: [
      { t: "Passion concentrate", target: "30 L", done: "27 L", who: "Amina W.", status: "Attention" },
...
function Prep() {
  return (
    <AppShell title="Prep list" subtitle="Thursday, 13 August · generated from forecast demand" actions={<><Btn>Print</Btn><Btn variant="primary">Regenerate</Btn></>}>
                ...
                <li key={t.t} className="px-4 py-3">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <div className="num text-[12px] text-muted-foreground">{t.done} of {t.target} · {t.who}</div>
                    </div>
