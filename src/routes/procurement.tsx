...
export const Route = createFileRoute("/procurement")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Purchase orders, receiving, supplier performance and payables in one flow.",
      },
      { property: "og:title", content: "Procurement - Seramet" },
      {
        property: "og:description",
        content: "Purchase orders, receiving and supplier performance.",
      },
    ],
  }),
    ...
    >
      ...
      <div className="mt-4 grid gap-4 xl:grid-cols-[minmax(0,1fr)_360px]">
        <Panel>
          <PanelHead
            title="PO-2026-0182"
            sub="Main Meat Supplier  -  Westlands  -  expected 14 Aug"
